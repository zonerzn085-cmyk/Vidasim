...
import MemoriesPanel from './components/MemoriesPanel'; // New
...
function GameContent(): React.ReactElement {
    ...
    return (
        <div className="h-dvh w-full bg-gradient-to-b from-gray-900 to-black flex flex-col overflow-hidden font-sans relative">
            {/* Overlays */}
